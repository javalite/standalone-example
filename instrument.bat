...
set CLASSPATH=%CLASSPATH%;lib\activejdbc-1.4.6.jar
set CLASSPATH=%CLASSPATH%;lib\javalite-common-1.4.6.jar
...
set CLASSPATH=%CLASSPATH%;build_time_libs\activejdbc-instrumentation-1.4.6.jar
